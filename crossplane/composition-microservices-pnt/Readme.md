...
* How to enable/disable microservices with PnT & Cel-Filter and visualize how Crossplane reconciles changes
...
```bash
# apply XRD
kubectl apply -f xrd-frontend.yaml
kubectl apply -f xrd-backend.yaml
...
# create composition
kubectl apply -f comp-frontend.yaml
kubectl apply -f comp-backend.yaml
kubectl apply -f comp-parent.yaml
